...
class IntSingleton {
 public:
  ...
  static IntSingleton* GetInstanceIfExists() {
    return Singleton<IntSingleton>::GetIfExists();
  }
...
class Init5Singleton {
 public:
  ...
  static Init5Singleton* GetInstanceIfExists() {
    return Singleton<Init5Singleton, Trait>::GetIfExists();
  }
...
class CallbackSingletonWithNoLeakTrait : public CallbackSingleton {
 public:
  ...
  static CallbackSingletonWithNoLeakTrait* GetInstanceIfExists() {
    return Singleton<CallbackSingletonWithNoLeakTrait, Trait>::GetIfExists();
  }
};
...
class CallbackSingletonWithLeakTrait : public CallbackSingleton {
 public:
  ...
  static CallbackSingletonWithLeakTrait* GetInstanceIfExists() {
    return Singleton<CallbackSingletonWithLeakTrait, Trait>::GetIfExists();
  }
};
...
class CallbackSingletonWithStaticTrait : public CallbackSingleton {
 public:
  ...
  static CallbackSingletonWithStaticTrait* GetInstanceIfExists() {
    return Singleton<CallbackSingletonWithStaticTrait, Trait>::GetIfExists();
  }
};
...
class AlignedTestSingleton {
 public:
  ...
  static AlignedTestSingleton* GetInstanceIfExists() {
    return Singleton<AlignedTestSingleton,
                     StaticMemorySingletonTraits<AlignedTestSingleton>>::GetIfExists();
  }
