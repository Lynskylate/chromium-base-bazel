...
class StackSamplingProfiler::SamplingThread : public Thread {
 public:
  ...
  static SamplingThread* GetInstanceIfExists();
...
StackSamplingProfiler::SamplingThread*
StackSamplingProfiler::SamplingThread::GetInstanceIfExists() {
  return Singleton<SamplingThread, LeakySingletonTraits<SamplingThread>>::GetIfExists();
}
